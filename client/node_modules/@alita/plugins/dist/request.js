...
exports.default = (api) => {
    ...
    api.onGenerateFiles(() => {
      ...
      `,
        ...
        api.writeTmpFile({
            path: 'types.d.ts',
            tpl: `export { ResponseError,Context,RequestConfig, RequestOptionsInit, RequestInterceptor, ResponseInterceptor } from '${(0, utils_1.winPath)((0, path_1.dirname)(require.resolve('@alita/request/package')))}';`,
            context: {},
        });
    });
